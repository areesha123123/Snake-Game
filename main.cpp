...
int N = 53, M = 30;                                                         //N is number of column , M is number of rows
int size;                                                                  //dimension of each cell

float timer = 0, delay = 0.1;                                              // delay , delays event timing
...
int main() {
    ...
    Texture t2, t3;                    //declaring textures and loading it form file
    ...
    while (window.isOpen()) {                          //game loop is started when window is open()
        ...
        window.clear();                                                          //the backgroud will be clear 
